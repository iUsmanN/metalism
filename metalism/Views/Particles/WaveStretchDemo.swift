//
//  WaveStretchDemo.swift
//  metalism
//
//  A wave sweeps left to right. As it passes through each column it
//  vertically stretches the pixels in that column. Chromatic aberration
//  and brightness increase toward the bottom (near camera).
//

import SwiftUI

struct WaveStretchDemo: View {
    ...
    private func sceneCanvas(size: CGSize) -> some View {
        Canvas { ctx, canvasSize in
            ...
            var rng = SeededRNGStretch(seed: 13)
...
private struct SeededRNGStretch {
